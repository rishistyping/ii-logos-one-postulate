...
| Add proof-oriented visuals and a readable proof-map layer. | Current thread: the user asked for module flow, theorem spine, branch split, Killing-form explainer, and paper/Lean/notebook visual crosswalks. | `fae4848`; `README.md`; `docs/proof-visuals.md`; Mermaid proof maps for the Killing-form explainer and paper/Lean/notebook crosswalk; `wolfram/assets/notebook_preview_*.svg` | `mathematica-sympy-one-postulate`, `origin/mathematica-sympy-one-postulate` | current branch | High |
